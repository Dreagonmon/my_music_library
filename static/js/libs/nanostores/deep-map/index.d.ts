import type { WritableAtom } from '../atom/index.d.ts'
import type { AllPaths, BaseDeepMap, FromPath } from './path.d.ts'

export { AllPaths, BaseDeepMap, FromPath, getPath, setPath } from './path.d.ts'
